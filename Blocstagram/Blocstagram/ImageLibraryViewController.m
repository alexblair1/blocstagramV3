...
//  Blocstagram
//
//  Created by Stephen Blair on 6/24/15.
...
//assignment: new cell padding that matches the Photos App
- (void) viewWillLayoutSubviews {
    ...
    CGFloat minlineSpace = flowLayout.minimumLineSpacing = 1;
    CGFloat newCellSizeWidth = cellSize - minlineSpace;
    flowLayout.itemSize = CGSizeMake(newCellSizeWidth, cellSize);
